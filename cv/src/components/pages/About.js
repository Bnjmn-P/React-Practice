  ...
  return (
    <section id="about">
      ...
      <p>
        ...
        problem-solving. I derive immense satisfaction from the creative process
        of finding solutions and the ongoing refinement that development
        demands. Witnessing conceptual ideas transform into functional software
        with the potential to positively impact users is particularly rewarding.
      </p>
      <p>
        Throughout my academic journey, I've actively engaged in group projects
        employing various agile methodologies and extreme programming. I
        appreciate the pace, adaptability, and structure these approaches bring
        to collaborative endeavors. I've also come to understand the importance
        of sound development practices, including coding standards, thorough
